            ...
            <div className="flex justify-center animate-slide-up">
              <div className="relative">
                ...
                <div className="relative w-80 h-[700px] bg-gradient-to-br from-slate-900 to-slate-800 rounded-[3rem] p-6 shadow-luxury border border-slate-700">
                  <div className="w-full h-full bg-gradient-to-br from-neutral-50 to-purple-50/30 rounded-[2rem] overflow-hidden relative shadow-inner">
                    {/* Status Bar */}
                    <div className="bg-gradient-to-r from-slate-900 to-slate-800 h-6 flex items-center justify-between px-6 text-neutral-50 text-xs">
                      ...
                      <div className="flex space-x-1">
                        ...
                        <div className="w-1 h-1 bg-pink-400 rounded-full animate-pulse" style={{ animationDelay: '0.6s' }}></div>
                      </div>
                    </div>
                ...
                {/* Decorative Elements */}
                <div className="absolute -top-10 -right-10 w-24 h-24 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-20 animate-float blur-lg"></div>
                ...
                <div className="absolute top-1/4 -left-6 w-10 h-10 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full opacity-25 animate-bounce-slow blur-sm"></div>
                <div className="absolute bottom-1/4 -right-4 w-8 h-8 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-30 animate-float blur-sm" style={{ animationDelay: '2s' }}></div>
              </div>
            </div>

            {/* Template Information */}
            <div className="animate-slide-up">
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-3xl shadow-luxury border border-purple-500/20 p-6">
                ...
                <div className="p-4 bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl border border-purple-500/20">
