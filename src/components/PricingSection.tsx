    ...
    <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-neutral-100 via-amber-50/30 to-purple-50/20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto backdrop-blur-sm bg-neutral-50/50 rounded-xl p-4 border border-amber-200/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => {
            ...
            return (
              <div
                key={plan.name}
                className={`relative bg-gradient-to-br ${gradientColors[index]} rounded-3xl shadow-luxury hover:shadow-glow-amber transition-all duration-500 p-8 backdrop-blur-sm border ${
                  plan.popular 
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent mb-2">{plan.name}</h3>
                  
                  <div className="flex items-baseline justify-center mb-4">
                    <span className="text-5xl font-bold bg-gradient-to-r from-slate-900 via-amber-700 to-slate-900 bg-clip-text text-transparent">{plan.price}</span>
