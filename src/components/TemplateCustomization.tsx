        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div
                onClick={() => handleInputChange('backgroundImage', 'https://i.weddinghero.ca/gallery/5458/preview_sunam-events_qMCdiF1y.jpg')}
                className="cursor-pointer group"
              >
                <div className="relative h-20 rounded-xl overflow-hidden border-2 border-transparent group-hover:border-amber-400 transition-all duration-300">
                  <img
                    src="https://i.weddinghero.ca/gallery/5458/preview_sunam-events_qMCdiF1y.jpg"
                    alt="Template 3"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                  />
                  <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-all duration-300"></div>
              ...
              <div
                onClick={() => handleInputChange('backgroundImage', 'https://esdomera.com/cdn/shop/files/unique-leaf-wedding-band-art-deco-gemstone-bridal-ring-14k-rose-gold-unique-stacking-matching-ring-esdomera-1.jpg?v=1744014709')}
                className="cursor-pointer group"
              >
                <div className="relative h-20 rounded-xl overflow-hidden border-2 border-transparent group-hover:border-amber-400 transition-all duration-300">
                  <img
                    src="https://esdomera.com/cdn/shop/files/unique-leaf-wedding-band-art-deco-gemstone-bridal-ring-14k-rose-gold-unique-stacking-matching-ring-esdomera-1.jpg?v=1744014709"
                    alt="Template 4"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                  />
                  <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-all duration-300"></div>
