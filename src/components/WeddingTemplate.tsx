...
import { Heart, Calendar, MapPin, Users, Wine, Camera, MessageCircle, QrCode, ArrowLeft, Check, Star, Sparkles } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto mb-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-gradient-to-r from-amber-500 to-amber-600 text-slate-900 px-6 py-3 rounded-full hover:from-amber-600 hover:to-amber-700 transition-all duration-300 font-semibold shadow-glow-amber transform hover:scale-105"
            >
                            ...
                            <div className="mb-6">
                              <div className="flex justify-center items-center mb-4">
                                <div className="relative">
                                  <Heart className="h-12 w-12 text-amber-400 animate-glow drop-shadow-2xl" />
                                  <div className="absolute inset-0 animate-ping">
                                    <Heart className="h-12 w-12 text-amber-300 opacity-30" />
                                  </div>
                                </div>
                              </div>
